...
* amount of memory used by OccupancyGrid. Also, if you change the value, you'll need to update maebot_occupancy_grid_t
* accordingly.
* 
...
public:
    ...
    */
    ...
    std::size_t heightInCells (void) const { return height_; }
    ...
    */
    maebot_occupancy_grid_t toLCM(void) const;
